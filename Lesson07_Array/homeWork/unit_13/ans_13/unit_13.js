...
function f6() {
    let out = '';
    let a1 = document.querySelector('.i-61').value;
    let a2 = document.querySelector('.i-62').value;
...
function f18() {
    let out = "";
    let put = document.querySelector('.i-18').value;

    for (let key in a18) {
        if (key == put) {
            for (let ar in a18[key]) {
                out += a18[key][ar] + " ";
            }
            break
        } else {
...
function f19() {
    let out = "";
    let put = document.querySelector('.i-19').value.toLowerCase()

    for (let key in a19) {
        for (let ar in a19[key]) {
            if (a19[key][ar].toLowerCase() == put) {
                out = key;
            }
            else if (out == '') {
                out = "";
